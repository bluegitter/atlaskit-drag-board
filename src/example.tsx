...
import { ColumnMap, ColumnType, getBasicData, Person } from './pragmatic-drag-and-drop/docs/examples/data/people';
import Board from './pragmatic-drag-and-drop/docs/examples/pieces/board/board';
import { BoardContext, BoardContextValue } from './pragmatic-drag-and-drop/docs/examples/pieces/board/board-context';
